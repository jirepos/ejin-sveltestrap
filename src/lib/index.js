...
// new modal
export { default as NewModal, showElementInfo } from './NewModal.svelte';

export { default as NewModalBody } from './NewModalBody.svelte';
export { default as NewModalFooter } from './NewModalFooter.svelte';
export { default as NewModalHeader } from './NewModalHeader.svelte';
